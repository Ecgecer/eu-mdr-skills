...
<!-- eval-cost:start -->
**$206 of eval spend so far**, across 49 stored runs of 5 suites and 30 cases, at 3 runs per case per arm. The largest single run (`device-claims`, 10 cases, both arms) was **$16.39** and took 97 minutes.
<!-- eval-cost:end -->
