...
<!-- eval-cost:start -->
**$132 of eval spend so far**, across 36 stored runs of 5 suites and 30 cases, at 3 runs per case per arm. The largest single run — `device-claims`, 10 cases, both arms — was **$15.92** and took 93 minutes.
<!-- eval-cost:end -->
