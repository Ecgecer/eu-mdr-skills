...
<!-- bench-counts:start -->
Of the 30 cases, **12 are ones Claude failed in every run** with no reference material and no
web access, 12 it passed in every run, and 6 it passed only sometimes. All three
