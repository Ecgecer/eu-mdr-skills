...
description: >
  Write the scope statement for a compliance check, audit, validation or readiness
  result — what was checked, against what, what was NOT checked, and what the result
  does not establish. Use when the user has a compliance output, a "you are ready"
  claim, a validation report, an audit result or a checklist result and needs it
  bounded before anyone acts on it. Also use when asked "what should this report say
  it doesn't cover".
argument-hint: "[paste the result, claim, or describe the check]"
---
